...
import { mergeCourses, fetchServerCourses } from "@/lib/mergeCourses";
...
export default async function Page(){
 ...
 const Courses=mergeCourses(serverCourses, []) as UICourse[];

 return <CoursesPage server_Courses={Courses}/>
}
